...
Turn a $200 creative console into the steering wheel for AI.

One button to code. One button to research. A dial to control how deep the AI thinks. A haptic buzz when it is done.
...
[Website](https://hausorlabs.tech) &middot; [npm](https://www.npmjs.com/package/wispy-ai) &middot; [Wispy Source](https://github.com/hausorlabs/wispy)
...
Developers got so frustrated they started running agents with all safety controls disabled. On Hacker News, one developer admitted:
...
### The Keypad: 9 LCD Buttons

<div align="center">
<img src="https://raw.githubusercontent.com/brn-mwai/wispy-console/main/assets/button-pages.svg" alt="Button Layout with Multi-Page Navigation" width="100%" />
</div>
...
The diagram above traces the full lifecycle of a hardware interaction: from button press or dial turn, through the Actions SDK, into the adapter layer, to the AI engine, and back as LCD updates + haptic feedback.
...
<div align="center">
<img src="https://raw.githubusercontent.com/brn-mwai/wispy-console/main/assets/webmcp-integration.svg" alt="WebMCP Integration Browser-Native Agent Control" width="100%" />
</div>

<br />

Wispy Console also integrates with WebMCP for browser-native agent control. The MX Creative Console buttons can trigger MCP tool calls directly from the browser, bridging hardware controls with web-based AI workflows.
...
<div align="center">
<img src="https://raw.githubusercontent.com/brn-mwai/wispy-console/main/assets/wizard-setup.svg" alt="Setup Wizard First-Run Configuration Flow" width="100%" />
</div>

<br />

The first-run wizard walks you through connecting your hardware, selecting your AI agent, and configuring button layouts. Agent auto-detection scans for running instances of Wispy, OpenClaw, and other supported agents on their default ports.
...
|---|---|---|
| **Permission prompt fatigue** | [#2560](https://github.com/anthropics/claude-code/issues/2560) (36+ upvotes), [#11380](https://github.com/anthropics/claude-code/issues/11380) (30+ upvotes) | Physical approve/reject buttons. One press. Haptic confirmation. |
| **Binary YOLO-or-nothing** | [HN](https://news.ycombinator.com/item?id=46268222): "unusable without yolo mode" | Thinking depth dial. Graduated control from Flash to Marathon. |
| **Catastrophic YOLO failures** | [#12637](https://github.com/anthropics/claude-code/issues/12637): `rm -rf ~/` in YOLO mode | Physical danger zone on dial. Haptic warning. No binary switch. |
| **Context switching** | [HN](https://news.ycombinator.com/item?id=43927914): "context switch then forget the details" | Dedicated hardware. Eyes stay on code. Haptic buzz when done. |
| **Multi-agent management** | [#15898](https://github.com/anthropics/claude-code/issues/15898): "no way to get back without restarting" | Actions Ring agent switcher. Per-agent LCD buttons. |
| **Accessibility barriers** | [CHI 2025](https://dl.acm.org/doi/10.1145/3706598.3714008): "exacerbated existing barriers" | Haptic state encoding. Voice input. Physical buttons. |
| **Trust crisis** | [SO 2025](https://stackoverflow.blog/2025/12/29/developers-remain-willing-but-reluctant-to-use-ai-the-2025-developer-survey-results-are-here): 66% spend more time correcting AI | Graduated autonomy dial. Review at your comfort level. |
...
| **Phase 2** (Post-SDK GA) | Full LCD rendering with agent status icons, thinking depth gauges, live token counters |
| **Phase 3** | More adapters -- Claude Code, Aider, Continue.dev, Cursor, generic REST |
| **Phase 4** | Team mode -- shared profiles, multi-console agent coordination |
| **Phase 5** | Marketplace distribution (free + pro). MX Ink integration for spatial AI in VR. |
...
| **Pro** | $4.99/mo | Voice, custom mappings, multi-agent, Marathon controls, wallet dashboard |
| **Team** | $9.99/mo | Shared profiles, team coordination, admin controls |
...
All technical blueprints are available as SVGs in the [`assets/`](assets/) directory:

| Blueprint | Description |
|---|---|
| [`hardware-blueprint.svg`](assets/hardware-blueprint.svg) | MX Creative Console + MX Master 4 hardware overview |
| [`button-pages.svg`](assets/button-pages.svg) | 9-button LCD grid with multi-page navigation |
| [`thinking-dial.svg`](assets/thinking-dial.svg) | Thinking depth dial with zone breakpoints |
| [`actions-ring.svg`](assets/actions-ring.svg) | Context-aware Actions Ring per application |
| [`architecture.svg`](assets/architecture.svg) | Full-stack architecture from hardware to AI |
| [`data-flow.svg`](assets/data-flow.svg) | End-to-end data flow from input to response |
| [`webmcp-integration.svg`](assets/webmcp-integration.svg) | WebMCP browser integration layer |
| [`wizard-setup.svg`](assets/wizard-setup.svg) | First-run setup wizard flow |
